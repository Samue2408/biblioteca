...
public interface ReservationRepository extends JpaRepository<Reservation, Long> {
    ...
    @Query("""
        ...
        """)
    List<Reservation> findWithBookByBorrowerOrderByRequestDateDesc(@Param("borrower") AppUser borrower);

    long countByBookAndStatusAndRequestDateBefore(Book book, ReservationStatus status, LocalDateTime requestDate);
}
